...
/* Apply the matchday-1 results that were already reflected in the shipped
   standings. Keyed by "group:home:away" so it survives schedule tweaks. */
const PLAYED_RESULTS = {
  // Group A — Mexico +2, S.Korea +1, Czechia -1, S.Africa -2
  'A:mex:rsa': [2, 0],
  'A:kor:cze': [1, 0],
